...
The latest 8.2 Automation API online help is available [here](http://help.quali.com/Online%20Help/8.1.0.4291/Python-API/).
...
In addition, the CloudShell Automation API package provides the necessary APIs to execute orchestration scripts in the sandbox:

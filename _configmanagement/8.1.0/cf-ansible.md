...
This can be easily done by deploying the <a href="http://help.quali.com/doc/8.1/VA-Linux/Content/Linux/Home.htm" target="_blank">Linux Virtual Appliance</a>, which installs the Execution Server and Ansible on a Linux machine.
